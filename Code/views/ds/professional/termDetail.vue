<template>
  ...
  <div class="right-basic">
    <div class="detail-return">
       <el-button class="edit-back" @click="handleBack" size="small">返回</el-button>
    </div>
      ...
      <el-tabs v-model="activeName" type="card" @tab-click="handleClickTab">
        ...
        <el-tab-pane label="关系信息" name="second">
          <div class="detail-collapse">
            <el-collapse v-model="activeNames">
              <el-collapse-item title="应用" name="second">
                <div class="code-table">
                  <el-table
        ...
        <el-tab-pane label="认责信息" name="third">
          <div class="detail-collapse">
            <el-collapse v-model="confessActiveNames" >
              ...
              <el-collapse-item title="使用人" name="3">
                ...
                <div @click="addPerson('使用人')" class="confess-creator confess-add" v-permission="'TERM_EIDT'">
    ...
    handleCommand(command) {
      ...
      this.$router.push({
        ...
        params: {
          ...
          id: this.paramss.id,
          _title: generateLineageTitle(command, this.paramss.name)
        }
      })
    },
    handleEdit() {
      this.$emit("handleEdit", this.paramss.row)
    },
    // 删除
    handleDeleteShow() {
      ...
      this.$nextTick(() => {
        this.$refs.deleteMenuDialog.getAllMsg(this.paramss.id);
      })
    },
    handleDelete() {
      this.$confirm(
