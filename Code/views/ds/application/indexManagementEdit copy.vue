<!--指标管理 编辑页面-->
<template>
  <div class="master-data-edit dashboard-editor-container">
    <el-card shadow="hover">
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="基本信息" name="first">
            <el-collapse v-model="aBaseInfoActiveNames">
              <el-collapse-item class="title terms" title="业务属性" name="1">
                <!--引用业务术语-->
                ...
                <el-form :model="baseInfoRuleForm" :rules="baseInfoRules" ref="baseInfoRuleForm" label-width="110px" style="width:60%;margin-top:20px;">
                  <opinion-input-type v-for=" (val,index) in inputData" :key="val.columnName" :item="inputData[index]" :ref="'input_'+val.columnName" v-show="val.hidden!==true"
              ...
              <el-collapse-item class="title" title="技术属性" name="2">
                <el-form :model="baseTechForm"  ref="baseTechForm" :rules="baseInfoRules2" label-width="110px" style="width:60%;margin-top:20px;">
      ...
      <div class="checkSame">
        <el-dialog title="提示" :visible.sync="showSames" width="30%">
          <template slot="title">
