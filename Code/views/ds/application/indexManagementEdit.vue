<!--指标管理 编辑页面-->
<template>
  <div class="master-data-edit">
    <el-card shadow="hover">
      <div slot="header" class="clearfix">
        <el-button  size="small" class="edit-back" @click="$emit('colse')">返回</el-button>
      </div>
       <div class="clearfix card-header2">
        ...
        <span class="title"> {{headerTitle}} </span>  <el-tag type="success" v-if="sStatus">{{sStatus}}</el-tag>
        <div class="button-box" style="float: right">
          <el-dropdown @command="handleCommand">
            ...
            <el-dropdown-menu slot="dropdown" trigger="click" style="width:80px;text-align:center;">
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick" type="card">
          <el-tab-pane label="基本信息" name="first" class="base-info">
            ...
            <el-collapse-item class="title" name="1">
              <template slot="title">
                <i class="line"></i>{{oBaseInfoData.oBusinessData.sTitle}}
              </template>
            ...
            <el-collapse-item class="title" name="2">
              <template slot="title">
                <i class="line"></i>{{oBaseInfoData.oTechAttr.sTitle}}
              </template>
          ...
          <el-tab-pane label="关系信息" name="second">
            <div class="relationship">
              ...
              <div class="button">
                <el-tooltip class="item" effect="dark" content="新增" placement="top" v-permission="'INDEX_EDIT'">
                  <el-button type="text" @click="toAddReference">
                    <svg-icon icon-class="addindetail" class="addindetail" style="width:22px;height:22px;"></svg-icon>
                  </el-button>
                </el-tooltip>
                <el-tooltip class="item" effect="dark" content="删除" placement="top" v-permission="'INDEX_EDIT'">
              ...
              <div class="table">
                <el-table :data="relationData.tableData" border style="width: 100%" size="small" :header-cell-style="{background:'#f8f8f9',textAlign:'left'}" :cell-style="isClass" :header-cell-class-name="isClass2"
          ...
          <el-tab-pane label="认责信息" name="third">
            <el-collapse class="confess-account" v-model="confessActiveNames">
              ...
              <el-collapse-item title="使用人" name="3">
                <!--名片组件 删除和增加-->
                <businessCardEdit :cardList="user" :oneOrMore="'more'"  @toDelCard="toDelCard(arguments)" @toAddCard="toAddCard('user')" v-permission="'INDEX_EDIT'"></businessCardEdit>
                <businessCard  :cardList="user" v-non-permission="'INDEX_EDIT'"></businessCard>
              </el-collapse-item>
              <el-collapse-item title="归口责任人" name="4">
                <businessCardEdit  :cardList="prncipal" :oneOrMore="'one'" :isParentNode="isParentNode" @toDelCard="toDelCard(arguments)" @toAddCard="toAddCard('prncipal')" v-if="isParentNode" v-permission="'INDEX_EDIT'"></businessCardEdit>
                <businessCard v-else :cardList="prncipal" v-permission="'INDEX_EDIT'"></businessCard>
                <businessCard  :cardList="prncipal" v-non-permission="'INDEX_EDIT'"></businessCard>
              </el-collapse-item>
            </el-collapse>
          </el-tab-pane>
        </el-tabs>
    ...
    <!-- 关系信息弹窗 -->
    <el-dialog :visible.sync="bReferenceIsVisible" class="relationTip">
      <div slot="title">
        请选择参考来源
      </div>
      <div>
    ...
    <el-dialog :visible.sync="deleteDialog" class="delete-dialog" title="删除提示" width="50%">
      ...
      <div class="dialog-btn" style="text-align: center">
...
<script>
  ...
  // import opinionInputType from "./dimensionality/opinionInputType";
  ...
  export default {
    ...
    methods: {
        ...
        get('/ds/application/index/getDetailInfos', {
          ...
          parseAjaxResponse(res, () => {
            if (res.code === 10000) {
              ...
              // 页面标题
              this.headerTitle = res.data.indexEnName ? res.data.indexName + '(' + res.data.indexEnName + ')' : res.data.indexName
      ...
      toEdit() {
        this.$parent.$parent.$parent.toEdit(this.routeData);
      },
      deleteItem() {
            ...
            post('/ds/application/index/removeIndex', {
              ...
              parseAjaxResponse(res, () => {
                if (res.code === 10000) {
                  ...
                  this.$parent.$parent.$parent.setCurrentPageToOne();
                  this.$emit('colse');
                  // 关闭当前页面
        ...
        post('/ds/listAccountability', {
          ...
          parseAjaxResponse(res, () => {
            if (res.code === 10000) {
              ...
              // console.log(this.oUser.pfilterSponsorData, this.prncipal, 'this.prncipa')
            }
          })
        })
      },
      ...
      getIndexListReferenceInfos() { // 参考
        get('/ds/application/index/listReferenceInfos', {
          indexId: this.instanceId,
          pageCurrent: this.relationData.oPage.pageCurrent,
          pageSize: this.relationData.oPage.pageSize
        }).then((res) => {
          parseAjaxResponse(res, () => {
            // 参考
      ...
      clickReferTable(row, column, event) {
        ...
        //   return item;
        // });
        // if (!this.referSource.referTag.includes(row)) {
      ...
      // 选择用户 - 确定
      toSaveUser() {
        // console.log(this.oUser.aChoiceTagId, this.oUser.pfilterSponsorData)
        let params = {
          instanceId: this.instanceId,
      ...
      toSaveTerms(tagData) {
        ...
        if (tagData !== undefined) {
          ...
          this.inputData.forEach((item, index) => {
            if (item.columnName === this.oBizTerm.sCnName) { // 指标名称
    ...
    created() {
      ...
      // if (this.$route.params.nodeList1) {
      //   this.nodeList = this.$route.params.nodeList1;
      // }
      // this.getIndexDetailInfos()
      // this.getEnNameStoreColumn()
      // this.getListBizTermInfoItemAttrStoreColumn()
