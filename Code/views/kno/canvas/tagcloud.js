/* eslint-disable */
!function(t, e) {
  "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("TagCloud", [], e) : "object" == typeof exports ? exports.TagCloud = e() : t.TagCloud = e()
  ...
  function() {
      return function(t) {
          ...
          e.a = {
              ...
              data: function() {
                  return {
                      option: {
                          ...
                          maxFont: 24,
                          color: '#fff',
                          rotateAngleXbase: 700,
                          rotateAngleYbase: 700,
                          hover: true
                      },
                      tagList: []
                  }
              ...
              created: function() {
                console.log('created')
                  null != this.config && (this.option = Object.assign({},
              ...
              methods: {
                  _initTags: function() {
                      if (this.rotateAngleX = Math.PI / this.option.rotateAngleXbase, this.rotateAngleY = Math.PI / this.option.rotateAngleYbase, this.option.hover) {
                          var t = this;
                          this.$refs.wrapper.onmousemove = function(e) {
                              t.rotateAngleY = (e.pageX - this.offsetLeft - this.offsetWidth / 2) / 1e8,
                                    t.rotateAngleX = -(e.pageY - this.offsetTop - this.offsetHeight / 2) / 1e8

                          }
                          this.$refs.wrapper.onmouseout = function(e) {
                              t.rotateAngleY = (e.pageX - this.offsetLeft - this.offsetWidth / 2) / 2e4,
                                  t.rotateAngleX = -(e.pageY - this.offsetTop - this.offsetHeight / 2) / 2e4
                      ...
                      for (var e = 0,
                          ...
                          this.option.color ? this.$refs.tag[e].style.color = this.option.color: this.$refs.tag[e].style.color = "rgb(" + Math.round(255 * Math.random()) + "," + Math.round(255 * Math.random()) + "," + Math.round(255 * Math.random()) + ")";
                          var u = {
                              x: i,
                              y: a,
                              z: s,
                      ...
                      this.timer = setInterval(function() {
                              for (var t = 0; t < c.tagList.length; t++) c.rotateX(c.tagList[t]),
                                  c.rotateY(c.tagList[t]),
                                  c.setPosition(c.tagList[t], c.option.radius, c.option.maxFont)
                          },
                          20)
                  },
                  setPosition: function(t, e, n) {
                      this.$refs.wrapper && (t.ele.style.transform = "translate(" + (t.x + this.$refs.wrapper.offsetWidth / 2 - t.ele.offsetWidth / 2) + "px," + (t.y + this.$refs.wrapper.offsetHeight / 2 - t.ele.offsetHeight / 2) + "px)", t.ele.style.opacity = t.z / e / 2 + .7, t.ele.style.fontSize = (t.z / e / 2 + .5) * n + "px")
                  },
                  rotateX: function(t) {
                  ...
                  dbclickTag: function() {
                      if (this.timer) clearInterval(this.timer),
                          ...
                          var t = this;
                          this.timer = setInterval(function() {
                                  for (var e = 0; e < t.tagList.length; e++) t.rotateX(t.tagList[e]),
          ...
          function(t, e, n) {
              ...
              var r = n(0),
                  ...
                  a = n(8),
                  s = o,
                  u = a(r.a, i.a, !1, s, "data-v-47d2ac61", null);
              e.a = u.exports
          },
          function(t, e, n) {
              var o = n(4);
          ...
          function(t, e, n) {
              e = t.exports = n(5)(!1),
                  e.push([t.i, ".tag-cloud[data-v-47d2ac61]{width:300px;height:300px;position:relative;color:#333;margin:0 auto;text-align:center}.tag-cloud p[data-v-47d2ac61]{position:absolute;top:0;left:0;color:#333;font-family:Arial;text-decoration:none;margin:0 10px 15px 0;line-height:18px;text-align:center;font-size:16px;padding:4px 9px;display:inline-block;border-radius:3px}", ""])
          },
          function(t, e) {
              function n(t, e) {
                  var n = t[1] || "",
          ...
          function(t, e) {
              t.exports = function(t, e) {
                  for (var n = [], o = {},
                      ...
                      o[a] ? o[a].parts.push(f) : n.push(o[a] = {
                          id: a,
                          parts: [f]
                      })
                  }
